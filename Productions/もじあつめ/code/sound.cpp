...
{
	//BGM
	g_SoundRecord.BGMGameID = LoadSound((char*)"data/BGM/MusMus-CT-NV-24.wav");

	//SE
	g_SoundRecord.SETitleID = LoadSound((char*)"data/SE/Japanese_School_Bell02-01_Slow-Long_.wav");
	g_SoundRecord.SEWaitID= LoadSound((char*)"data/SE/Countdown03-2.wav");
	g_SoundRecord.SEResultID = LoadSound((char*)"data/SE/Japanese_School_Bell02-08_Far-Slow-Mid_.wav");
	g_SoundRecord.SEButtonID = LoadSound((char*)"data/SE/opendoor.wav");
	g_SoundRecord.SECorrectID = LoadSound((char*)"data/SE/Quiz-Correct_Answer02-1.wav");
	g_SoundRecord.SEWrongID = LoadSound((char*)"data/SE/Quiz-Wrong_Buzzer02-1.wav");
	g_SoundRecord.SEGameEndID = LoadSound((char*)"data/SE/Whistle.wav");
}
...
{
	//BGMの音量更新
	SetVolume(g_SoundRecord.BGMGameID, g_VolumeBGM);

	//SEの音量更新
	SetVolume(g_SoundRecord.SETitleID, g_VolumeSE);
	SetVolume(g_SoundRecord.SEWaitID, g_VolumeSE);
	SetVolume(g_SoundRecord.SEResultID, g_VolumeSE);
	SetVolume(g_SoundRecord.SEButtonID, g_VolumeSE);
	SetVolume(g_SoundRecord.SECorrectID, g_VolumeSE);
	SetVolume(g_SoundRecord.SEWrongID, g_VolumeSE);
	SetVolume(g_SoundRecord.SEGameEndID, g_VolumeSE);
}
