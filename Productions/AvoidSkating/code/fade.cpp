...
void DrawFade(void)
{
	...
	UI ui = { {  SCREEN_WIDTH * 0.5f, SCREEN_HEIGHT * 0.5f }, 0, { SCREEN_WIDTH, SCREEN_HEIGHT }, { 0.0f, 0.0f}, {1.0f, 1.0f,}, g_Color };
	DrawScreen(ui, RefImageMaterial().m_White);
}
